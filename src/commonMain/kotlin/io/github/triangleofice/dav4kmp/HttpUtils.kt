...
public object HttpUtils {
    ...
    public fun listHeader(response: HttpResponse, name: String): Array<String> =
     ...
     */
    public fun formatDate(date: DateTime): String = httpDateFormat.format(date)
     ...
     */
    public fun parseDate(dateStr: String): DateTimeTz? {
...
public suspend fun ByteReadChannel.isEmpty(): Boolean = isClosedForRead || peek(1) == null
