...
public data class Response(
    ...
    public enum class HrefRelation {
        SELF, MEMBER, OTHER
    }
     ...
     */
    public inline operator fun <reified T : Property> get(clazz: KClass<T>): T? =
     ...
     */
    public fun isSuccess(): Boolean = status?.status?.isSuccess() ?: true

    /**
     * Returns the name (last path segment) of the resource.
     */
    public fun hrefName(): String = HttpUtils.fileName(href)

    public companion object {

        public val RESPONSE: QName = QName(XmlUtils.NS_WEBDAV, "response")
        public val MULTISTATUS: QName = QName(XmlUtils.NS_WEBDAV, "multistatus")
        public val STATUS: QName = QName(XmlUtils.NS_WEBDAV, "status")
        public val LOCATION: QName = QName(XmlUtils.NS_WEBDAV, "location")

        /**
         * Parses an XML response element.
         */
        public fun parse(parser: XmlReader, location: Url, callback: MultiResponseCallback) {
            var href: Url? = null
